...
import { Button, Steps, theme, Input, DatePicker, Select, Carousel, ConfigProvider } from 'antd';
        ...
        <ConfigProvider
          theme={{
            token: {
              ...
              // Alias Token
              colorStepsTitle: '#A8CD9F', // Step başlık rengini ayarlamak için
              colorStepsDescription: '#A8CD9F', // Step açıklama rengini ayarlamak için
              colorStepsDot: '#A8CD9F', // Step dot rengini ayarlamak için
            },
          }}
        >
          ...
          <div style={{ marginTop: 24 }}>
            ...
            {current > 0 && (
              <Button
                style={{ margin: '0 8px', color: "#7F9F80", backgroundColor:"#a8cd9f46"}}
                onClick={() => prev()}
              >
                Previous
              </Button>
